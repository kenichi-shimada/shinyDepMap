...
```{r summary_q10_r80_1, child="rmd_depmap/efficacy_selectivity_summary_1.Rmd"}
## remove weak points
...
-----------------------------------------------------------------------
### Gene sets
```{r gene_sets1, child="rmd_depmap/gene_sets_1.Rmd"}
```

### Lineage
```{r lineage1, child="rmd_depmap/lineage_1.Rmd"}
